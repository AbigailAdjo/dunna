package com.nawoagency.dunna.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.nawoagency.dunna.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.nawoagency.dunna.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.nawoagency.dunna.domain.Visitor.class.getName() + ".countries");
