...
public class Visitor implements Serializable {
    ...
    public Visitor countries(Set<Country> countries) {
        this.countries = countries;
        return this;
    }

    public Visitor addCountry(Country country) {
        this.countries.add(country);
        country.setVisitor(this);
        return this;
    }

    public Visitor removeCountry(Country country) {
        this.countries.remove(country);
        country.setVisitor(null);
        return this;
    }
